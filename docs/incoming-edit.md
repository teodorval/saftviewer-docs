...
Той съдържа всички основни, редови и продуктови данни, необходими за правилното осчетоводяване и SAF‑T класификация.![Екран Редакция на приходни документи](img/sales_invoice_edit.png){.zoomable}
---
