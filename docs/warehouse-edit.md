...
Той съдържа всички основни, документни и редови параметри, необходими за правилното осчетоводяване и проследяване на движението на материалите.![Екран Редакция на складова операция](img/warehouse.png)
---
