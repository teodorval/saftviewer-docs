...
![Екран Редакция на стока](img/product-edit-screen.png){.zoomable}
---
...
Екранът **„Редакция на стока“** е централното място за управление на продуктовите параметри в Saf‑t Accounting.
Той позволява:
