...
Той е идентичен по структура с екрана за приходни документи, но е ориентиран към доставчици и покупки.
...
Екранът **„Редакция на разходен документ“** е основният инструмент за управление на покупните фактури в SAFTViewer.  
Той осигурява:
