...
Той е идентичен по структура с екрана за приходни документи, но е ориентиран към доставчици и покупки.![Екран Редакция на разходни документи](img/purchase_invoice_edit.png)
---
