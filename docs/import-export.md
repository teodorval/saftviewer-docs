...
Табът **Импорт / Экспорт** служи за обмен на данни между Saf‑t Accounting и външни системи чрез SAF‑T XML файлове.
...
Файлът може да бъде **по‑свободен** от официалния SAF‑T формат:
...
| Поле | Описание |
|------|-----------|
| **Тип файл** | Избор на вид отчет (GeneralLedger, SourceDocuments и др.) |
...
Табът **Импорт / Экспорт** е основният инструмент за обмен на данни между Saf‑t Accounting и външни системи.
Той осигурява:
...
Това е ключов модул за интеграция и отчетност в Saf‑t Accounting.
