...
Модулът се намира в секцията **Осчетоводяване** и е достъпен от главния екран чрез бутона **Плащания**.  
...
Това е ключов модул за ежедневната финансова работа в SAFTViewer.
