...
Той съдържа всички основни параметри, редове и счетоводни връзки, необходими за правилното осчетоводяване и SAF‑T класификация.![Екран Редакция на плащане](img/payment_edit1.png)
---
