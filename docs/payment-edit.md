...
Той съдържа всички основни параметри, редове и счетоводни връзки, необходими за правилното осчетоводяване и SAF‑T класификация.
...
Екранът **„Редакция на плащане“** е основният инструмент за управление на плащанията в SAFTViewer.  
Той осигурява:
