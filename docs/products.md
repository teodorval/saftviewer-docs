...
Табът **Продукти** служи за управление на всички артикули, стоки и услуги, използвани в системата SAFTViewer.  
...
Табът **Продукти** е достъпен като отделен модул от главния екран на SAFTViewer.  
...
Табът **Продукти** е основният инструмент за управление на артикулите и услугите в SAFTViewer.  
Той осигурява:
