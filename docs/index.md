# SAFTViewer User Guide

SAFTViewer е настолно приложение за визуализация, анализ и проверка на SAF‑T данни.  
...
След стартиране на SAFTViewer първият прозорец показва списък с фирмите, които имат конфигурирана база данни.
...
След избор на фирма SAFTViewer зарежда основния работен прозорец.  
...
Документацията се разширява постепенно и включва всички екрани на SAFTViewer.
